...
public class UserService {
    ...
    @Autowired
    private JounelRepository jounelRepository;
    ...
    public UserEntity PostnewAllty(UserEntity userEntity) {
...
@Transactional
    ...
    public List<JournelEntries> GetPendingRequestsall() {
        return jounelRepository.findPendingPapers();
    }
